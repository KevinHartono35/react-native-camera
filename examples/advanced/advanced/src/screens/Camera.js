...
class Camera extends Component {
  ...
  render() {
    ...
    let whiteBalance = isCustomWhiteBalance
      ? this.state.customWhiteBalance
      : WB_OPTIONS[wb];
    const {currentCustomWBOption} = this.state;
    let customWhiteBalanceValue = this.state.customWhiteBalance[
      currentCustomWBOption
    ];
                ...
                <React.Fragment>
                  ...
                  {isCustomWhiteBalance && (
                    <View style={styles.customWBView}>
                      <Button
                        style={styles.customWBViewButton}
                        onPress={this.changeCustomWBOption}>
  ...
  changeWB = () => {
    ...
    const numberOfOptions = IS_IOS
      ? Object.keys(WB_OPTIONS_MAP).length
      : WB_OPTIONS.length;
    this.setState({
  ...
  changeCustomWBOption = () => {
    ...
    let currentOptionIndex = optionKeys.indexOf(
      this.state.currentCustomWBOption,
    );
